...
from modules.covariates import (
    WEEKDAY_BASELINE_SCENARIO,
    WEEKDAY_COVARIATE_SCOPES,
    WEEKDAY_ENCODINGS,
    build_forecast_weekday_metric_summary,
    build_weekday_covariate_frames,
    build_weekday_scenario_name,
    get_weekday_scenario_color,
                ...
                with st.spinner("모델을 불러오고 예측하는 중입니다..."):
                    ...
                    if compare_forecast_weekday_covariate:
                        (
                            ...
                            timestamp_column=timestamp_column,
                            target_column=target_column,
                            metrics_builder=compute_metrics,
                        )
